...
try:
    ...
    cursor.execute("""
            ...
            FROM games
            JOIN pitchers AS away_pitcher ON games.away_pitcher_id = away_pitcher.pitcher_id
            JOIN pitchers AS home_pitcher ON games.home_pitcher_id = home_pitcher.pitcher_id
